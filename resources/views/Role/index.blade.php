                ...
                <div class="card mb-4 mx-4">
                    <div class="card-header pb-0">
                        <div class="d-flex flex-row justify-content-between">
                            ...
                            <a href="{{ asset('/tambah-role') }}" class="btn bg-gradient-info btn-sm mb-0"
                                type="button">Tambah Role</a>
                        </div>
                    </div>
                                    ...
                                    @forelse ($roles as $role)
                                        ...
                                        <tr>
                                            ...
                                            <td class="text-center ">
                                                ...
                                                <a href="/edit-role/{{ $role->id }}" type="button" class="mx-3"
                    ...
                    <div class="card-footer d-flex justify-content-end">
                        @if ($roles->total() < 11)
                            <p class="text-xs font-weight-bold mb-0 text-wrap">Showing
                                {{ $roles->firstItem() }} to {{ $roles->lastItem() }} of
                                {{ $roles->total() }} results
                            </p>
                        @else
