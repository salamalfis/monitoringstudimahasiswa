                ...
                <div class="card mb-4 mx-4">
                    <div class="card-header pb-0">
                        <div class="d-flex flex-row justify-content-between">
                            ...
                            <a href="/tambah-dosen" class="btn bg-gradient-info btn-sm mb-0" type="button">Tambah Dosen</a>
                        </div>
                    </div>
                        ...
                        <div class="table-responsive p-0">
                            <table class="table align-items-center mb-0">
                                ...
                                <tbody>
                                    ...
                                    @forelse ($dosen as $dosenitem)

                                        <tr>

                                            <td class="text-center">
                                                <p class="text-xs font-weight-bold mb-0">
                                                    {{ $loop->iteration + $dosen->firstItem() - 1 }}
                                                </p>
                                            </td>
                                            <td class="text-center">
                                                <p class="text-xs font-weight-bold mb-0">
                                            ...
                                            <td class="text-center">
                                                <p class="text-xs font-weight-bold mb-0">
                                                    {{ $dosenitem->peminatan->nama }}
                                                </p>
                                            </td>
                                            <td class="text-center">
                                                <p class="text-xs font-weight-bold mb-0">
                                                    {{ $dosenitem->labriset->nama }}
                                                </p>
                                            </td>
                                            <td class="text-center">
                                                <a href="/edit-dosen/{{ $dosenitem->id }}" type="button"
                                                ...
                                                <a href="/delete-dosen/{{ $dosenitem->id }}"
                    ...
                    <div class="card-footer d-flex justify-content-end">
                        @if ($dosen->total() < 11)
                            <p class="text-xs font-weight-bold mb-0 text-wrap">Showing
                                {{ $dosen->firstItem() }} to {{ $dosen->lastItem() }} of
                                {{ $dosen->total() }} results
                            </p>
                        @else
