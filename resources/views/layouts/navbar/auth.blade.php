     ...
     <div class="container-fluid py-1 px-3">
         <nav aria-label="breadcrumb">
             <ol class="breadcrumb bg-transparent mb-0 pb-0 pt-1 px-0 me-sm-6 me-5">
                 <li class="breadcrumb-item text-sm"><a class="opacity-5 text-dark" href="{{ asset('dashboard') }}">Pages</a></li>
         ...
         <div class="collapse navbar-collapse mt-sm-0 mt-2 me-md-0 me-sm-4 d-flex justify-content-end" id="navbar">
             ...
             <ul class="navbar-nav  justify-content-end">
                 <li class="nav-item d-xl-none px-2 d-flex align-items-center">
                     <a onclick="" type="button" class="nav-link text-body p-0" id="iconNavbarSidenav">
                 ...
                 <li class="nav-item dropdown px-2 d-flex align-items-center">
                     <a href="{{ asset('') }}" class="nav-link text-body p-0" id="dropdownMenuButton" data-bs-toggle="dropdown"
                         aria-expanded="false">
