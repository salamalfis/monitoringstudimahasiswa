         ...
         <div class="collapse navbar-collapse mt-sm-0 mt-2 me-md-0 me-sm-4 d-flex justify-content-end" id="navbar">
             ...
             <ul class="navbar-nav  justify-content-end">
                 ...
                 <li class="nav-item dropdown px-2 d-flex align-items-center">
                     <a href="{{ asset('') }}" class="nav-link text-body p-0" id="dropdownMenuButton"
                         ...
                         <li class="mb-2">
                             ...
                             <div class="d-flex flex-column justify-content-center">
                                 ...
                                 <a class="dropdown-item border-radius-md text-center"
                                     ...
                                     <i class="fa fa-user-circle me-2"></i> Profile</a>
                             </div>
                             </a>
                         </li>
                         <li class="mb-2">
                             <div class="d-flex flex-column justify-content-center">
                                 <a class="dropdown-item border-radius-md text-center" href="/logout">
